...
<body id="page-top">
	...
	<div id="wrapper">
		<div id="content-wrapper">
		  ...
		  ArrayList<InventoryBean> inventoryList = con.showInventory();
		  request.setAttribute("inventoryList",inventoryList);
               %>
            <c:forEach var="listItems" items="${inventoryList}">  
            <td><c:out value="${listItems.inventoryid}" /></td>
            <td><c:out value="${listItems.productid}" /></td>
            <td><c:out value="${listItems.location}" /></td>
            <td><c:out value="${listItems.stockqty}" /></td>
            <td><c:out value="${listItems.unitprice}" /></td>
            <td><c:out value="${listItems.vendorid}" /></td>
            </c:forEach> 
